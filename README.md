...
- **Step0**. Download AWE data from [https://bit.ly/35eoe2h](https://bit.ly/35eoe2h) and unzip to replace `AWEForSegmentation`.

- **Step1**. Run `python bitmask_to_txt.py` to extract annotations from AWE bitmasks.

- **Step2**. Run `python gen_shuffle_data.py 12` to generate 12net training data, then run `python gen_tfdata_12net.py` to build tfrecords file.
